...
// Schema defined using GraphQL schema language
const typeDefs = `
  scalar Date
...
// Create an executable schema using the schema def and the resolvers
const schema = makeExecutableSchema({
  typeDefs,
  resolvers,
});

// Start Express and add graphql middleware
express()
  .use('/graphql',
    bodyParser.json(),
